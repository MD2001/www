      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <?php if ($_SESSION["logging_in"] ?? false) : ?>
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="relative ml-3">
            <div>
              ...
              <?php else : ?>
                <a href="/registeration" class="<?= urlis("/registeration") ? "bg-gray-900 text-white " : "text-gray-300"; ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Register</a>
